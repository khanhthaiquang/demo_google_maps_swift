...
extension UIDevice {
    ...
    static var TABBAR_HEIGHT_X:CGFloat {
        return  CGFloat(83)
    }
    
    static var tabbarHeight:CGFloat {
        if iphoneXStyle {return TABBAR_HEIGHT_X}
    ...
    static var STATUS_HEIGHT_X:CGFloat {
        return  CGFloat(44)
    }
    
    static var statusHeight:CGFloat {
        if iphoneXStyle {return STATUS_HEIGHT_X}
    ...
    static var SPACE_SAFE:CGFloat {
        return  CGFloat(20)
    }

    static var LARGE_HEADER_HEIGHT:CGFloat {
        return  CGFloat(97)
    }
    
    
    static var headerHeight:CGFloat {
        return HEADER_HEIGHT + statusHeight
    }
    
    static var largeHeaderHeight:CGFloat {
        return LARGE_HEADER_HEIGHT + statusHeight
    }
    
    static var iphoneXStyle:Bool {
        if Device.IS_IPHONE_X {return true}
        if Device.IS_IPHONE_XS {return true}
        if Device.IS_IPHONE_XR_XSM {return true}
        return false;
    }
    ...
    struct Device {
        ...
        static let IS_IPHONE_XR_XSM    = IS_IPHONE && SCREEN_MAX_LENGTH == 896
    }
